...
*/
      ...
      */
      ...
      while ($d <= $daysInMonth)
      {
          ...
          for ($i = 0; $i < 7; $i++)
          {
              ...
              if ($year == $this->selYear && $month == $this->selMonth && 
                  $d == $this->selDay) {
                $selected = true;
              } else {
                $selected = false;
              ...
              $cells .= St::dddd($this->ddddCell, array(
                'today' => $today,
                'selected' => $selected,
                'day' => $d,
                'link' => $link,
          ...
          $rows .= St::dddd($this->ddddRow, array('cells' => $cells));
      }
      $d = array(
        'm' => $m,
        'y' => $y,
      ...
      for ($i=0; $i<=7; $i++)
        $d['weekday'.($i+1)] = $this->dayNames[($this->startDay + $i) % 7];
    ...
    */
    ...
    public $dayNames = array("Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб");
    ...
    */
    ...
    public $monthNames = array("Январь", "Февраль", "Март", "Апрель", "Май", "Июнь",
