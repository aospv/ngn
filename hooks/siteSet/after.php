...
$this->d['bodyClass'] = ($this->d['page']['module'] ? ' module_'.$this->d['page']['module'] : '').
($this->d['page']['settings']['ddItemsLayout'] ?
  ' ddil_'.$this->d['page']['settings']['ddItemsLayout'] : '');
