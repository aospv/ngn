  ...
  tinymce.create('tinymce.themes.AdvancedTheme', {
    ...
    init : function(ed, url) {
      ...
      t.settings = s = extend({
        ...
        theme_advanced_buttons1 : "undo,redo,|,fullscreen,|,bold,italic,underline,strikethrough,bullist,numlist,|,justifyleft,justifycenter,justifyright,formatselect,link,unlink,anchor",
        theme_advanced_buttons2 : "hr,visualaid,|,blockquote,sub,sup,charmap,|,cleanup,removeformat,help",
