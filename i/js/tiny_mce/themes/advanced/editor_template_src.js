  ...
  tinymce.create('tinymce.themes.AdvancedTheme', {
    ...
    init : function(ed, url) {
      ...
      t.settings = s = extend({
        ...
        theme_advanced_buttons2 : "bullist,numlist,|,undo,redo,|,link,unlink,anchor,image,cleanup,help,code",
...
*/
    ...
    _mceCodeEditor : function(ui, val) {
      ...
      alert(parseInt(ed.getParam("theme_advanced_source_editor_height", 580)));
