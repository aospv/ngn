...
var mooSelecta = new Class({
  ...
  initialize: function(options) {
    ...
    var selects = this.options.selects ||
      this.options.parentNode.getElements(this.options.selector);
  ...
  _addOption: function(option, el, selected) {
    ...
    mooSelectaObject.append(this.optionList, tempObj);
    // end store
  ...
  _hideOptions: function() {
    ...
    mooSelectaObject.values(this.selects).each(function(el) {
